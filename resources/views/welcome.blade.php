...
<div id="myModal" class="modal fade" role="dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						<label class="control-label col-sm-2" for="fname">Manufacturer</label>
						<div class="col-sm-10">
					...
					<div class="form-group">
						<label class="control-label col-sm-2" for="lname">Make</label>
						<div class="col-sm-10">
					...
					<div class="form-group">
						<label class="control-label col-sm-2" for="gender">Type</label>
						<div class="col-sm-10">
					...
					<div class="form-group">
						<label class="control-label col-sm-2" for="salary">Price $ </label>
						<div class="col-sm-10">
	...
	<script>
		$(document).ready(function() {
			$('#table').DataTable();	// looking for id="table"
		} );
	</script>
